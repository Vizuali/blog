...
description: "Image processing with convolutional matrix processing using p5js"
---
...
- [Kernel for convolution](https://en.wikipedia.org/wiki/Kernel_(image_processing))
